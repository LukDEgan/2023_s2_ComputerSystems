...
//testing mixed integers with overflow
set PC 0,
set RAM[0]  0,  // Set R0
set RAM[1]  100, // Set R1
set RAM[2]  5,  // Set R2
set RAM[100] -32760,  // Set Arr[0]
set RAM[101] 32760,  // Set Arr[1]
set RAM[102] -4828,  // Set Arr[2]
set RAM[103] -476;  // Set Arr[3]
set RAM[104] 4729;  // Set Arr[3]
repeat 800 {
