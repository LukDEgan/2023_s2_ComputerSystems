...
//testing larger number, I've had to move the local and arguement memory segments as they would otherwise overflow 
...
repeat 5000000 {        // Change this number to cover the number of instructions in the VM test file
  vmstep;
}
output;